...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUM] = LAYOUT_ansi_67(
        ...
        XXXXXXX, KC_SCLN, KC_4,    KC_5,    KC_6,    KC_EQL,  KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, XXXXXXX,          XXXXXXX,          XXXXXXX,
        XXXXXXX,          KC_SCLN, KC_4,    KC_5,    KC_6,    KC_EQL,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX,
    ...
    [_SYM] = LAYOUT_ansi_67(
        ...
        XXXXXXX, KC_COLN, KC_DLR,  KC_PERC, KC_CIRC, KC_PLUS, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, XXXXXXX,          XXXXXXX,          XXXXXXX,
    ...
    [_FN] = LAYOUT_ansi_67(
        ...
        XXXXXXX, KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_SCRL, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, XXXXXXX,          XXXXXXX,          XXXXXXX,
